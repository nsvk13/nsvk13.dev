    ...
    <main className="min-h-screen ascii-grid p-4 md:p-8">
      <div className="max-w-3xl mx-auto">
        <header className="mb-6 md:mb-8 pt-4 md:pt-12">
          <Link href="/blog" className="ascii-link inline-flex items-center mb-4 md:mb-6">
            <ArrowLeft className="h-4 w-4 mr-1" />
            <span>Back to blog</span>
          </Link>

          <h1 className="text-xl md:text-3xl font-bold mb-3 md:mb-4">{post.frontmatter.title || "Untitled Post"}</h1>
          ...
          <div className="ascii-divider mt-4 md:mt-6">
            <span className="px-2">nsvk13</span>
          </div>
        </header>

        <article className="ascii-frame ascii-frame-bottom p-4 md:p-6 mb-8 md:mb-12">
          <div className="prose prose-gold max-w-none" dangerouslySetInnerHTML={{ __html: content }} />
        </article>
